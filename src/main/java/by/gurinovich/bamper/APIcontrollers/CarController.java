...
public class CarController {
    ...
    @Autowired
    public CarController(CarBrandService carBrandService, CarModelService carModelService, CarModelGenerationService carModelGenetionService) {
        this.carBrandService = carBrandService;
        this.carModelService = carModelService;
        this.carModelGenetionService = carModelGenetionService;
    }
    ...
    @DeleteMapping("/brands/deleteBrand/{brand_id}")
    ...
    @GetMapping("/models/getModelsForBrand/{brand_id}")
    ...
    @PostMapping("/models/addModelForBrand/{brand_id}")
    public ResponseEntity<Object> addModelForCarBrand(@PathVariable("brand_id") Integer brand_id, @RequestBody CarModelDTO carModelDTO){
        ...
        if (carBrand == null)
            return new ResponseEntity<>("CarBrand with this id not found", HttpStatus.NOT_FOUND);
        carModelService.addModelForBrand(carBrand, carModelDTO);
        return new ResponseEntity<>(HttpStatus.CREATED);
    }

    @DeleteMapping("/models/deleteModelForBrand/{model_id}")
